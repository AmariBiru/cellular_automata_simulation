...
class UnifiedEvacuationUI:
    ...
    def create_menu(self):
        """Builds the scalable top menu bar."""
    ...
    def save_project(self):
        if not self.current_save_file:
            ...
            self.env.save_to_file(self.current_save_file)
    ...
    def create_layout(self):
        ...
        tk.Label(self.panel_left, text="Tools", font=("Arial", 12, "bold"), bg="#f0f0f0").pack(pady=5)
